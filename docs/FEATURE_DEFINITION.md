...
| AI 분석 | `Hannah-Montana-AI` | 종목 매핑, 이벤트 태그, 감성, 중요도, 요약, 중복 제거 키 생성, 금융 용어 normalization, 번역 품질 플래그, confidence와 review flag 생성 | Done: audited gold readiness pass, 사람 검수 gold 확장은 운영 품질 관리 |
...
`Naver/OpenDART -> Hana-OmniLens-API -> Hannah-Montana-AI analysis/confidence/review metadata -> DeepL translation -> Hana WebSocket alert -> Stock-exchange-BE matching/push -> Flutter iOS/Android 앱`
...
| Hannah-Montana-AI 분석 API | Done: audited gold readiness pass, 운영 drift/gold 보강은 지속 |
