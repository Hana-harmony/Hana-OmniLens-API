...
| 전문 기반 AI 분석 | `Hannah-Montana-AI` | 제목/snippet/전문을 함께 입력받아 종목 매핑, 이벤트 태그, 감성, 중요도, What/Why/Impact 3줄 요약, 중복 키를 생성. `financial-ml-tfidf-logreg-20260621225355`는 권리 안전 기사·공시 전문 gold를 포함해 학습하고 release/service readiness를 통과 | Done |
