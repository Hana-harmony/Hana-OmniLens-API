...
| v2 보강 기능 | 담당 | 내용 | 상태 |
| --- | --- | --- | --- |
| 기본 종목 수집 스케줄러 | `Hana-OmniLens-API` | 협력사 watchlist와 함께 `stock_master_priority` 인기 종목, 외국인 취득한도 제한 종목을 20종목 단위로 나누어 Naver News Search 발견 데이터와 OpenDART 공시를 주기 수집 | Done |
