...
- full-content news v2: DB 이벤트 저장소, REST 목록·상세, v2 필드 포함 저장 이벤트 WebSocket, Hannah 전문 기반 분석·What/Why/Impact 요약 모델 연동 완료. 전체 종목 shard 수집과 전문/이미지 권리 확인 provider 계약은 진행 중
