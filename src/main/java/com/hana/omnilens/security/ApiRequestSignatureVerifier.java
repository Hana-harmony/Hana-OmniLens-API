...
public class ApiRequestSignatureVerifier {
    ...
    public static final String TIMESTAMP_HEADER = "X-HANA-OMNILENS-TIMESTAMP";
    public static final String NONCE_HEADER = "X-HANA-OMNILENS-NONCE";
    public static final String SIGNATURE_HEADER = "X-HANA-OMNILENS-SIGNATURE";
