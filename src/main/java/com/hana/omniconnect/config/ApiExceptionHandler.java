...
public class ApiExceptionHandler {
    ...
    private static final URI VALIDATION_ERROR_TYPE = URI.create("https://hana-omni-connect-api/errors/validation");
    private static final URI STOCK_NOT_FOUND_TYPE = URI.create("https://hana-omni-connect-api/errors/stock-not-found");
    private static final URI PARTNER_ACCESS_DENIED_TYPE =
            URI.create("https://hana-omni-connect-api/errors/partner-access-denied");
