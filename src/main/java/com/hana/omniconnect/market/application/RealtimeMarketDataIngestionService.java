...
import com.hana.omniconnect.provider.market.KisRealtimeMessageParser;
...
import com.hana.omniconnect.market.stream.MarketIndexStreamingService;
import com.hana.omniconnect.market.stream.MarketQuoteStreamingService;
...
public class RealtimeMarketDataIngestionService {
    ...
    private void recordRealtimeMinutePrice(KisRealtimeTradeTick tick) {
        ...
        try {
            ...
            String market = stockMasterRepository.findByCode(tick.stockCode())
                    .map(com.hana.omniconnect.market.domain.StockSummary::market)
                    .orElse("UNKNOWN");
    ...
    private void recordRealtimeIndex(MarketIndexQuote quote) {
        ...
        try {
            ...
            marketIndexSnapshotRepository.recordRealtimeMinute(new com.hana.omniconnect.market.domain.MarketIndexIntradayPrice(
                    quote.indexCode(),
                    quote.indexName(),
                    quote.market(),
