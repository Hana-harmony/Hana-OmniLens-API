...
import com.hana.omniconnect.provider.ai.HannahAiFinancialTermEvidence;
import com.hana.omniconnect.provider.ai.HannahAiKoreanFinancialTermClient;
import com.hana.omniconnect.provider.ai.HannahAiKoreanFinancialTermExplainResponse;

@SpringBootTest(properties = {
        "omni-connect.security.rate-limit.enabled=false",
        "omni-connect.security.signature.enabled=false",
        "omni-connect.alert.dedupe.mode=in-memory",
        "omni-connect.alert.scheduler.enabled=false",
        "omni-connect.market-news.scheduler.enabled=false",
        "omni-connect.market.foreign-ownership-refresh.enabled=false",
        "omni-connect.market.foreign-ownership-model-training.enabled=false",
        "omni-connect.market.foreign-ownership-prediction-precompute.enabled=false",
        "omni-connect.market.kis-realtime.enabled=false",
        "omni-connect.market.chart-warmup.enabled=false",
