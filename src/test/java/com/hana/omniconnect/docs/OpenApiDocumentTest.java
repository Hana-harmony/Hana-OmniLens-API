package com.hana.omniconnect.docs;
...
class OpenApiDocumentTest {
    ...
    void servesOpenApiDocumentBehindPartnerApiKey() throws Exception {
        mockMvc.perform(get("/openapi.yaml")
                ...
                .andExpect(content().string(containsString("/api/v1/market/stocks/{stockCode}/global-peers")))
                ...
                .andExpect(content().string(containsString("GlobalPeerMatchApiResponse")))
                ...
                .andExpect(content().string(containsString("marketImpactImportance")))
                .andExpect(content().string(containsString("marketImpactScore")))
                .andExpect(content().string(containsString("marketImpactConfidence")))
                .andExpect(content().string(containsString("summaryLines")))
                .andExpect(content().string(containsString("originalContent")))
                .andExpect(content().string(containsString("contentAvailability")))
                .andExpect(content().string(containsString("clusterKey")))
                ...
                .andExpect(content().string(containsString("X-HANA-OMNI-CONNECT-API-KEY")))
                .andExpect(content().string(containsString("X-HANA-OMNI-CONNECT-SIGNATURE")))
