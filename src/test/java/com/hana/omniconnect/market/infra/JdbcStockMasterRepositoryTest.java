...
class JdbcStockMasterRepositoryTest {
    ...
    void upsertKeepsExistingEnglishNameWhenKisMasterHasOnlyKoreanName() {
        jdbcRepository.upsertAll(List.of(new com.hana.omniconnect.market.domain.StockSummary(
                "005930",
                "삼성전자",
                "삼성전자",
                "KOSPI",
    ...
    void reconcileMarketSnapshotDeactivatesOnlyMissingRowsAndReactivatesCurrentRows() {
        var stale = new com.hana.omniconnect.market.domain.StockSummary(
                "999991", "구종목", "Legacy Stock", "TEST", "KR7999991001", "");
        var current = new com.hana.omniconnect.market.domain.StockSummary(
    ...
    void updatePreferredShareDartCorpCodesFromCommonShares() {
        jdbcRepository.upsertAll(List.of(
                new com.hana.omniconnect.market.domain.StockSummary(
                        "003490",
                        "대한항공",
                        "Korean Air",
                        "KOSPI",
